...
This has been modified in an attempt to make it work with pterodactyl.
...
## Tips:
* You can copy the entire contents of /home/container/space-engineers/config to make a backup, including the SpaceEngineers-Dedicated.cfg file.
